...
/* package */ class Samples {
    ...
    public static final Sample[] YOUTUBE_DASH_MP4 = new Sample[]{
            ...
            new Sample("Google Play NOANALYTICS",
                    "http://www.youtube.com/api/manifest/dash/id/3aa39fa2cc27967f/source/youtube?"
                            + "as=fmp4_audio_clear,fmp4_sd_hd_clear&sparams=ip,ipbits,expire,source,id,as&ip=0.0.0.0&"
                            + "ipbits=0&expire=19000000000&signature=A2716F75795F5D2AF0E88962FFCD10DB79384F29."
                            + "84308FF04844498CE6FBCE4731507882B8307798&key=ik0", DemoUtil.TYPE_DASH),
    ...
    public static final Sample[] HLS = new Sample[]{
            ...
            new Sample("Apple ID3 metadata", "http://devimages.apple.com/samplecode/adDemo/ad.m3u8",
                    DemoUtil.TYPE_HLS),
            new Sample("Nice264 HLS LIVE", "http://cdn.s1.eu.nice264.com:1935/liveNice/niceLoop.smil/playlist.m3u8",
                    DemoUtil.TYPE_HLS),
            new Sample("Aljazeera HLS LIVE", "http://aljazeera-ara-apple-live.adaptive.level3.net/apple/aljazeera/arabic/160.m3u8",
                    DemoUtil.TYPE_HLS),
    };
