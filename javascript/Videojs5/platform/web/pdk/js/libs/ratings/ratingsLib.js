...
this.hideRating()
}else{this._adPlaying=false;
if(a.baseClip&&a.baseClip.ratings.length>0&&this._shouldBeDisplayed){this.nameMap.setRatings(a.baseClip.ratings);
this.showRating();
...
}},showRating:function(){if(this._adPlaying){return
}var b=this._namingProperties[this.imageManager.isHD()?"HD":"SD"][this._isFirstClip?0:1];
