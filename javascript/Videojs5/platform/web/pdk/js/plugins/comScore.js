...
$pdk.plugin.comScore = $pdk.extend(function(){},
{
	...
	initialize:function(lo)
	{
		...
		this._controller.addEventListener("OnReleaseStart", function(e) {
			that.onReleaseStart(e);
		});

		this._controller.addEventListener("OnMediaStart", function(e) {
			that.onMediaStart(e);
		});

		this._controller.addEventListener("OnReleaseEnd", function(e) {
			that.onReleaseEnd(e);
		});
...
$pdk.controller.plugInLoaded(comscorePlugIn, null);
