...
this._initAdLoader();
var a=this;
this._controller.addEventListener("OnPlayButtonClicked",function(){a._onUserInitiatedPlayback.apply(a,arguments)
});
this._controller.addEventListener("OnSetRelease",function(){a._onUserInitiatedPlayback.apply(a,arguments)
});
this._controller.addEventListener("OnSetReleaseUrl",function(){a._onUserInitiatedPlayback.apply(a,arguments)
});
this._controller.addEventListener("OnSetSmil",function(){a._onUserInitiatedPlayback.apply(a,arguments)
})
...
tpController.plugInLoaded(doubleclickPlugIn,doubleclickPlugIn._adContainer);