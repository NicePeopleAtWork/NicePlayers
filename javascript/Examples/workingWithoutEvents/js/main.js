//Instantiate Youbora
var youbora = new $YB.plugins.TizenAvplay('av-player', { httpSecure: false });
...
Main.onLoad = function () {
	...
	AVPlayer.prepare("http://media.w3.org/2010/05/sintel/trailer.mp4"); // <-- set video URL here!
...
(function(){
	...
	AVPlayer.play = function (url) {
		...
		youbora.playHandler({media:{resource: "http://media.w3.org/2010/05/sintel/trailer.mp4"}});
		youbora.resumeHandler();
