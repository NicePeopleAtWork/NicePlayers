 ...
 */
$YB.api.Ads.prototype.getAdResource = function() {
    try {
        var res = '';
 ...
 */
$YB.api.Ads.prototype.getMediaPlayhead = function() {
    try {
        var res = 0;
 ...
 * @return {number} Playhead in seconds (rounded) or 0
 */
$YB.api.Ads.prototype.getAdPlayhead = function() {
    try {
        var res = 0;
 ...
 */
$YB.api.Ads.prototype.getAdPosition = function() {
    try {
        var res = 'unknown';
 ...
 */
$YB.api.Ads.prototype.getAdTitle = function() {
    try {
        var res = '';
...
/**
 * Tries to get the mediaduration of the ad from {@link $YB.data.Options} > plugin.getAdDuration().
 * @return {number} Duration in seconds (rounded) or 0;
 */
$YB.api.Ads.prototype.getAdDuration = function() {
    try {
        res = 0;
...
/**
 * Tries to get the bitrate of the ad with {@link $YB.data.Options} > plugin.getAdBitrate().
 * @return {number} Bitrate or -1.
 */
$YB.api.Ads.prototype.getAdBitrate = function() {
    try {
        var res = -1;
...
/**
 * Tries to get the throughput of the ad with {@link $YB.data.Options} > plugin.getAdThroughput().
 * @return {number} throughput or -1.
 */
$YB.api.Ads.prototype.getAdThroughput = function() {
    try {
        var res = -1;
 ...
 */
$YB.api.Ads.prototype.getAdPlayerVersion = function() {
    try {
        var res = "";
...
$YB.api.Video = function(plugin) { // constructor
    /** Reference to the {@link $YB.api.Video|plugin} from where it was called. */
    this.plugin = plugin;
 ...
 */
$YB.api.Video.prototype.getResource = function() {
    try {
 ...
 * @return {number} Playhead in seconds (rounded) or 0
 */
$YB.api.Video.prototype.getPlayhead = function() {
    try {
        var res = 0;
 ...
 * @return {number} Duration in seconds (rounded) or 0;
 */
$YB.api.Video.prototype.getMediaDuration = function() {
    try {
        var res = 0;
 ...
 */
$YB.api.Video.prototype.getIsLive = function() {
    try {
 ...
 */
$YB.api.Video.prototype.getRendition = function() {
    try {
...
/**
 * Tries to get the bitrate of the video with {@link $YB.data.Options} > plugin.getBitrate().
 * @return {number} Bitrate or -1.
 */
$YB.api.Video.prototype.getBitrate = function() {
    try {
        var res = -1;
...
/**
 * Tries to get the throughput of the video with {@link $YB.data.Options} > plugin.getThroughput().
 * @return {number} Throughput or -1.
 */
$YB.api.Video.prototype.getThroughput = function() {
    try {
        var res = -1;
 ...
 */
$YB.api.Video.prototype.getPlayerVersion = function() {
    try {
        var res = "";
 ...
 */
$YB.api.Video.prototype.getTotalBytes = function() {
    try {
        var res = undefined;
 ...
 */
$YB.api.Video.prototype.getTitle = function() {
    try {
        var res = "";
...
/**
 * Define a map of {@link $YB.data.Options} objects.
 * @class
 * @memberof $YB.data
 */
$YB.data.Map = function() {
    this._map = {};
};
 ...
 * @readonly
 */
$YB.data.Map.prototype.getLength = function() {
 ...
 * @param {$YB.data.Options} data Data object.
 * @return {$YB.data.Options} Returns the data object.
 */
$YB.data.Map.prototype.add = function(id, data) {
 ...
 * @param {string} id Identifier of the data object.
 * @return {$YB.data.Options} Returns the data object.
 * @see {@link $YB.data.Map#add}.
 */
$YB.data.Map.prototype.get = function(id) {
    id = id || 'default'; //If called without id, fetch turn it to 'default'

    if (this._map.hasOwnProperty(id) === false) {
        this.add(id, new $YB.data.Options()); //if id does not exist inside the map, create it.
    }
...
/**
 * Singleton instance of {@link $YB.data.Map}.
 * @memberof $YB
 */
$YB.datamap = new $YB.data.Map();
/**
 * @license
 * Youbora Data
 * Copyright NicePopleAtWork <http://nicepeopleatwork.com/>
