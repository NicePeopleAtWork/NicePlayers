...
/**
 * Fills params variable with '/adStart' info.
 *
...
/**
 * Fills params variable with '/adJoinTime' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/adStop' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/adPause' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/adResume' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/adBufferUnderrun' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with (ad related) '/ping' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/start' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/joinTime' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/stop' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/pause' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/resume' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/bufferUnderrun' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/error' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
$YB.managers.Info.prototype.getErrorParams = function(params) {
    try {
        ...
        // Message & Errorcode
        params.msg = params.hasOwnProperty('errorCode') ? params.errorCode : '9000';
...
/**
 * Fills params variable with '/seek' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
...
/**
 * Fills params variable with '/ping' info.
 *
 * @param {Object} [params] Any parameter specified in this object will be sent along the AJAX request. The API will try to populate every param, so use this only if you need to override a specific param. Refer to the NQS API for more information.
 */
    ...
    try {
        if (!this.isHalted()) {
            if (this.isStartSent && this.isShowingAds) {
                ...
                // Log
                $YB.notice("Method: /genericAdEnd " + this.chrono.adIgnore.getDeltaTime() + "ms", 'darkgreen');
            }
    ...
    try {
        if (!this.isHalted()) {
            ...
            if (!this.isStartSent) {
                ...
                // Start pings
                $YB.notice("Sending pings every " + this.comm.pingTime + "s.", 'darkgreen');
...
$YB.managers.View.prototype.convertBufferToSeek = function() {
    try {
        $YB.notice("Converting buffer to seek");
    ...
    if (this.isJoinSent && !this.isShowingAds) {
        ...
        if (diffPlayhead < bufferThreshold) {
            ...
            if (this.enableSeekMonitor) {
                if (this.lastPlayhead > 0 && !this.IsSeeking) {
                    if (this.isBuffering) {
            ...
            if (this.isSeeking) {
                this.sendSeekEnd();
            } else if (this.isBuffering && this.chrono.buffer.getDeltaTime(false) > minBuffer) {
                this.sendBufferEnd();
            }
        }
