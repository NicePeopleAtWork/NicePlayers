...
$YB.PingApi.prototype.sendPing = function(params, callback) {
    try {
        ...
        // Save last info sent
        this.plugin.videoApi.lastPlayhead = params.eventTime;
...
$YB.Data.prototype = {
     ...
     * @prop {number} [media.bitrate] Bitrate of the media.
     * @prop {number} [media.thoughput] Thoughput of the media.
     * @prop {(number|string)} [media.rendition] Rendition of the media. Either number "10000" or name "HighDef".
...
$YB.utils.listenAllEvents = function(o, extraEvents, report) {
    try {
        if ($YB.errorLevel >= 4) {
            ...
            var playerEvents = [
                'canplay', 'buffering', 'waiting', 'ended', 'play', 'playing', 'pause', 'resume', 'error', 'abort',
                'seek', 'seeking', 'seeked', 'stalled', 'dispose', 'loadeddata', 'loadstart', 'adstart', 'adend'
            ];
            if (extraEvents) {
