...
$YB.api.Info.prototype.getBitrate = function() {
    try {
        ...
        // Chrome workarround
        var isChromecast = window.cast && cast.player; // is chromecast
        if (!isChromecast &&
            res == -1 &&
            this.plugin.tag &&
            typeof this.plugin.tag.webkitVideoDecodedByteCount != "undefined"
        ) {
...
$YB.api.Video.prototype.sendStart = function(params, callback) {
    try {
        ...
        if (this.plugin.data.parseCDNNodeHost) {
            params.nodeHost = typeof params.nodeHost != 'undefined' ? params.nodeHost : (typeof this.plugin.resourceParser.nodeHost != 'undefined' ? this.plugin.resourceParser.nodeHost : "");
            params.nodeType = typeof params.nodeType != 'undefined' ? params.nodeType : (typeof this.plugin.resourceParser.nodeType != 'undefined' ? this.plugin.resourceParser.nodeType : "");
        }
