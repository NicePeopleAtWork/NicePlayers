...
if (typeof $YB != 'undefined') {
    ...
    $YB.plugins.UWP = function(playerId, options) {
        try {
            /** Name and platform of the plugin.*/
            this.pluginName = 'uwp';

            /** Version of the plugin. ie: 5.1.0-name */
            this.pluginVersion = '5.1.0-uwp';
    ...
    $YB.plugins.UWP.prototype = new $YB.plugins.Generic;


    /** Register and listen an instance of Windows.Media.Streaming.Adaptive.AdaptiveMediaSource */
    $YB.plugins.UWP.prototype.setMediaSource = function(ms) {
        this.mediaSource = ms;
    };


    /** Returns the current playhead of the video or 0. */
    $YB.plugins.UWP.prototype.getPlayhead = function() {
        return this.player.currentTime;
    };

    /** Returns the media duration of the video or 0. */
    $YB.plugins.UWP.prototype.getMediaDuration = function() {
        return this.player.duration;
    };

    /** Returns true if the video is life, or false if it is a VOD. */
    $YB.plugins.UWP.prototype.getIsLive = function() {
        if (this.mediaSource) {
    ...
    $YB.plugins.UWP.prototype.getPlayerVersion = function() {
    ...
    $YB.plugins.UWP.prototype.getBitrate = function() {
        if (this.mediaSource) {
    ...
    $YB.plugins.UWP.prototype.getThroughput = function() {
        if (this.mediaSource) {
    ...
    /** Register Listeners */
    $YB.plugins.UWP.prototype.registerListeners = function() {
        try {
