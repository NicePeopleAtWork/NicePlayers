...
if (typeof $YB != 'undefined') {
    ...
    $YB.plugins.Clappr = function(player, options) {
        try {
            ...
            this.pluginVersion = '5.3.0-clappr';
    ...
    // Save default playEvent
    $YB.plugins.Clappr.playEvent = Clappr.Events.PLAYBACK_BUFFERING;
    ...
    $YB.plugins.Clappr.prototype.registerListeners = function() {
        try {
            ...
            // PLAYBACK EVENTS
            this.playback.on($YB.plugins.Clappr.playEvent, function() {
                // IMPORTANT: As per Clappr 0.2.52, player does not have START event
                // So we'll let the client chose which event to use with:
                // Assign false to control start manually.
                //
                // $YB.plugins.Clappr.playEvent = Clappr.Events.PLAYBACK_BUFFERING;
