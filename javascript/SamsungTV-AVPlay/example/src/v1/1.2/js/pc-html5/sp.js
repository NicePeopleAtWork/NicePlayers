...
var SmartPlugin = { 
    ...
    { 
        try
        {
            var playerEvents = [ "canplay" , "playing" , "waiting", "timeupdate", "ended", "play", "pause", "error", "abort","seeking","seeked" ];
        ...
        switch ( e.type )
        {
            case "timeupdate": 
                ...
                {  
                    ...
                    if(isNaN(SmartPlugin.duration)) { SmartPlugin.resourceNotFound();  return false; } 
            ...
            case "abort": 
                ...
                try 
                {
                    ...
                    else
                    {
                        ...
                        SmartPlugin.checkBuffering();             
                        clearInterval(SmartPlugin.pingTimer); 
                        SmartPlugin.apiClass.sendErrorWithParameters(5000,"USER_ABORTED", 0, window.location.href, "", youboraData.getLive(), SmartPlugin.urlResource, SmartPlugin.duration); 
                        SmartPlugin.reset();
                    } 
    ...
    resourceNotFound: function ( ) 
    {
        try 
        {
            ...
            if ( SmartPlugin.debug )
            {
                console.log ( "SmartPlugin :: "+ SmartPlugin.pluginName  +" :: resourceNotFound" );
            }
            ...
            else
            {
                ...
                SmartPlugin.checkBuffering();             
                clearInterval(SmartPlugin.pingTimer); 
                SmartPlugin.apiClass.sendErrorWithParameters(5003,"MEDIA_ERR_SRC_NOT_SUPPORTED", 0, window.location.href, "", youboraData.getLive(), SmartPlugin.urlResource, SmartPlugin.duration); 
                SmartPlugin.reset(); 
            } 
        ...
        catch ( error )
        {
            if ( SmartPlugin.debug )
            {
                console.log ( "SmartPlugin :: "+ SmartPlugin.pluginName  +" :: resourceNotFound :: Error: " + error );
            }
        }
    },
