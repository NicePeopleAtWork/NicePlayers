...
var SmartPlugin={
    ...
    findVideo : function(){
        ...
        if(this.player == null){
            ...
            console.log("Silverlight Element name " +  silverlightMediaElementName);
...
function Silverlight2Media()
{
    ...
    this.setMediaElement = function() {
        ...
        if (_this.mediaElement == null) {
            console.log("Media element is null so far");
            ...
            if (embeddedSilverlightControl) {
                if (embeddedSilverlightControl.content) {
                    ...
                    try {
                        ...
                        console.log("Te result of the media Element is : ");
                        console.log(_this.mediaElement);
                    }
                    catch(e) {
...
function Nice264Analytics()
{
  ...
  //  this.player = null;
    ...
    // configuration
    this.pluginVersion = "2.0.1._silverlight";
