...
var SmartPlugin = { 
    ...
    targetDevice: "PANASONIC-HTML",
    pluginName: "PANASONICTV",
    pluginVersion: "3.1.0",
    initDone: 0, 
    // Balancer
    ...
    {
        if ( SmartPlugin.balanceIndex < 10 ) { return "00" + SmartPlugin.balanceIndex; }
        else if ( SmartPlugin.balanceIndex > 10 ) { return "0" + SmartPlugin.balanceIndex; }
        else { return "000"; }
    },
