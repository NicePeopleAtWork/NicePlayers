var SmartPlugin = {
   ...
   Init: function()  {  
       try
       { 
           console.log ( "SmartPlugin :: SMAMSUNGTV :: Init Lluis" );           
    ...
    Play: function(url) { 
       try {
           ...
           SmartPlugin.urlResource = url;         
            ...
            {
                 SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration, youboraData.getTransaction());
                 SmartPlugin.setPing();
