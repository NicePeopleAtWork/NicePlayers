...
var SmartPlugin = {
        ...
        try {
            ...
            while (i < all.length && !found) {
                ...
                if (element.type != undefined) {
                    if (element.type.indexOf("video") == 0 || element.type.indexOf("application/x-netcast-av") != -1 || element.type.indexOf("application/vnd.ms-sstr+xml") != -1) {
    ...
    init: function() {
        ...
        this.player.onPlayStateChange = function() {
            context.myCheckPlayState();
            context.oldFunction.call(this);
        };
