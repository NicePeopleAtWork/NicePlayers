            ...
            case "timeupdate": 
                ...
                {  
                    ...
                    if ( SmartPlugin.currentTime > 0 ) {
                        ...
                        {
                            SmartPlugin.apiClass.sendStart ( 0 , window.location.href , "" , youboraData.getLive() , SmartPlugin.urlResource , 0 );
                            SmartPlugin.setPing(); 
                    ...
                    if(!SmartPlugin.seeking){
                        ...
                        if ( SmartPlugin.urlResource != "" ) 
                        {
                            ...
                            else 
                            {
                                ...
                                if ( !SmartPlugin.isStartSent )
                                {
                                    SmartPlugin.apiClass.sendStart ( 0 , window.location.href , "" , youboraData.getLive() , SmartPlugin.urlResource , 0 ,youboraData.getTransaction() );
                                    SmartPlugin.setPing(); 
                                    SmartPlugin.isStartSent = true;
                                }
                                if ( SmartPlugin.isPaused )
