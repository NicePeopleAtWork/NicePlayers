/*
    ...
    Author: Lluis Campos Beltran
    Author: Miguel Angel Zambrana
    Author: Ferran Guti 
    Version: 3.1.0 
*/

try { if (!window.console) { var console = {}; } if (!console.log) { console.log = function () {}; } } catch (error) { }
            ...
            if (((spYoubora.foundDevice == spYoubora.deviceNames.PC) || (spYoubora.foundDevice == spYoubora.deviceNames.MAC)) && spYoubora.foundTechnology == spYoubora.technologyNames.HTML5) {
                ...
                if (spYoubora.isSmartPluginLoaded() == false) {
                    if (this.forcedVersion != undefined) {
                        ...
                        spYoubora.loadJavascriptFile(spYoubora.urlBaseJS + 'pc-videojs/3.3.4/sp.js', function () { SmartPlugin.Init(); });
                    }
                } else { SmartPlugin.Init(); }
                ...
                if (spYoubora.isSmartPluginLoaded() == false) {
                    if (this.forcedVersion != undefined) {
                        ...
                        spYoubora.loadJavascriptFile(spYoubora.urlBaseJS + 'tv-samsung/3.1.0/sp.js', function () { SmartPlugin.Init(); });
                    }
                } else { SmartPlugin.Init(); }
