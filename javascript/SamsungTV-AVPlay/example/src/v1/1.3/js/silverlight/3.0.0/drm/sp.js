...
var Nice264PlayerEvents = new Array("buffering", "play", "pause", "ended", "error", "abort", "timeupdate", "canplaythrough","progress","loadstart","updatestart","updateend","waiting","fullscreenchanged","onfullscreenchanged");
/**
 * Plugin definition.
 * @param playerId
 * @param system
...
Nice264Analytics.prototype.onPlayEvent = function(e) 
{
    ...
    console.log("INPLAYEEVENT  2" + e.type);
