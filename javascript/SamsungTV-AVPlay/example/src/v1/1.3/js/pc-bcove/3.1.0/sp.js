        ...
        switch (e.type) {
            ...
            case "mediaStop":
                try {
                    ...
                    if (e.position >= e.duration && SmartPlugin.isStartSent) {
                        SmartPlugin.checkBuffering();
    ...
    setBrightCoveURL: function (url) {
        ...
        try {
            ...
            if (!SmartPlugin.isStartSent) {
                ...
                SmartPlugin.apiClass.sendStart(0, window.location.href, SmartPlugin.getMetadata(), youboraData.getLive(), SmartPlugin.urlResource, SmartPlugin.duration, youboraData.getTransaction());
                SmartPlugin.setPing();
            }
        } catch (error) {
            if (SmartPlugin.debug) {
