...
package
{
	...
	{   
		...
		protected var pluginVersion:String = "3.1.4_BrightCove-SWF";
		...
		override protected function initialize():void { 
			...
			if(debug) { ExternalInterface.call("console.log('SmartPlugin :: BRIGHTCOVE :: onInitialize 3.1.4')"); } 
		...
		{ 
			...
			try
			{
				...
				{ 
					...
					try
					{ 
						ExternalInterface.call("window.location = '" + concurrencyRedirectUrl + "';");
					}
					catch(e:Error)
					{
						if(debug)
		...
		private function onMediaPlayerBegin(event:MediaEvent):void
		{
			try
			{
				...
				if(debug)
				{
					ExternalInterface.call("console.log('SmartPlugin :: BRIGHTCOVE :: Player Begin Event')");
				} 
