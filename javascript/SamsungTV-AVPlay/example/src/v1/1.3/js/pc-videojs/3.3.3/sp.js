            ...
            case "error":
                try 
                {
                    if ( youboraData.getBalanceEnabled() && SmartPlugin.apiClass.enableBalancer )
                    {
                        ...
                        SmartPlugin.apiClass.sendAdvancedError("131" + SmartPlugin.getBalancerErrorCount(), "CDN_PLAY_FAILURE",SmartPlugin.targetDevice, 0, window.location.href, "", youboraData.getLive(), SmartPlugin.balanceObject[SmartPlugin.balanceIndex]['URL'], SmartPlugin.videoPlayer.duration());
                    ...
                    else
                    {
                        ...
                        SmartPlugin.apiClass.sendAdvancedError(error, SmartPlugin.targetDevice,message, 0, window.location.href, "", youboraData.getLive(), resource,  SmartPlugin.videoPlayer.duration());
            ...
            case "playing": 
                try
                {
                    if(!SmartPlugin.isAdvertisment) {
                        ...
                        if ( !SmartPlugin.isJoinSent ) {     SmartPlugin.setBu
                        fferEvent(SmartPlugin.mediaEvents.BUFFER_END); }
