...
function YouboraData() {
    try {
        ...
        this.ooyalaNameSpace=undefined;
        ...
        this.init();
    } catch (error) {  if (this.debug) { console.log("YouboraData :: Error [Function] :: " + error) }  }
} 
...
YouboraData.prototype.getTransaction = function () {
    ...
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [getTransaction] :: " + error); } } 
};
...
YouboraData.prototype.getUsername = function () {
    ...
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [getUserName] :: " + error); } }
};
...
YouboraData.prototype.setJwplayerOverlayEnabled = function (enabled) {
    ...
    catch (error) { console.log("YouboraData :: Error [setJwplayerOverlayEnabled] :: " + error) }
};
...
YouboraData.prototype.setConcurrencyEnabled = function (enabled) {
    ...
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [setConcurrencyEnabled] :: " + error); } }
};
...
YouboraData.prototype.setConcurrencyCode = function (code) {
    ...
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [setConcurrencyCode] :: " + error); } }
};
...
YouboraData.prototype.setConcurrencyService = function (service) {
    ...
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [setConcurrencyService] :: " + error); } }
};
...
YouboraData.prototype.setSilverlightMediaElementName = function (mediaElementName) {
    ...
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [setSilverlightMediaElementName] :: " + error); } }
};
YouboraData.prototype.getSilverlightMediaElementName = function () {
    try { return this.silverlightMediaElementName; }
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [getSilverlightMediaElementName] :: " + error); } }
};
...
YouboraData.prototype.getSilverlightPlayer = function () {
    ...
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [getSilverlightPlayer] :: " + error); } }
};
...
YouboraData.prototype.setNqsDebugServiceEnabled = function (nqsDebugEnabled) {
    ...
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [SET nqsDebugServiceEnabled] :: " + error); } }
};
...
YouboraData.prototype.getOoyalaNamespace = function () {
    try { return this.ooyalaNameSpace; }
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [GET ooyalaNameSpace] :: " + error); } }
};
YouboraData.prototype.setOoyalaNamespace = function (nameSpace) {
    try { this.ooyalaNameSpace = nameSpace; }
    catch (error) { if (this.debug) { console.log("YouboraData :: Error [SET ooyalaNameSpace] :: " + error); } }
};
