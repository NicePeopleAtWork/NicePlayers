...
TokenGenerator.prototype.generateToken = function(service,zoneCode,originCode,resourcePath,secretWord, nva,nvb,niceTokenIp)
{
	...
	if (niceTokenIp != null && niceTokenIp != undefined){
...
TokenGenerator.prototype.str2byteString = function(str)
{
	//var bytes = [];
	var byteString = "";
...
TokenGenerator.prototype.calculateNVA = function(niceNVA)
{
...
TokenGenerator.prototype.calculateNVB = function(nvb)
{
	return this.calculateBaseTime();

};

TokenGenerator.prototype.calculateBaseTime = function(){
	var d = new Date();
