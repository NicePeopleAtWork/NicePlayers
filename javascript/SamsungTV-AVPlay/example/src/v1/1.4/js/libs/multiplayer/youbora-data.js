...
function YouboraDataMap() {

	this.map = new Array();
	this.length = 0;
}

YouboraDataMap.prototype.add = function (playerId, youboraData) {
	if (this.map[playerId] == undefined) {
		this.length++;
	}
	this.map[playerId] = youboraData;
}

YouboraDataMap.prototype.get = function (playerId) {
	if (this.map.hasOwnProperty(playerId) === false) {
		youboraDataMap.add(playerId, new YouboraData());
	}
...
YouboraData.prototype.init = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Init Error: " + error);
		}
	}
};
YouboraData.prototype.collectParams = function () {
	try {
		...
		for (var i = 0; i < scripts.length; i++) {
			if (scripts[i].src.indexOf('youbora-data') != -1) {
				index = i;
			}
		}
		...
		for (var i = 0; i < Pairs.length; i++) {
			...
			if (key == "mediaResource") {
				this.setMediaResource(val);
			}
			if (key == "transaction") {
			...
			if (key == "propertyFileName") {
				this.setPropertyFileName(val);
			}
			if (key == "propertyContentId") {
				this.setPropertyContentId(val);
			}
			if (key == "propertyTransactionType") {
				this.setPropertyTransactionType(val);
			}
			if (key == "propertyQuality") {
				this.setPropertyQuality(val);
			}
			if (key == "propertyContentType") {
				this.setPropertyContentType(val);
			}
			if (key == "propertyDeviceManufacturer") {
				this.setPropertyDeviceManufacturer(val);
			}
			if (key == "propertyDeviceType") {
				this.setPropertyDeviceType(val);
			}
			if (key == "propertyDeviceYear") {
				this.setPropertyDeviceYear(val);
			}
			if (key == "propertyDeviceFirmware") {
				this.setPropertyDeviceFirmware(val);
			}
			if (key == "propertyMetaTitle") {
				this.setPropertyMetaTitle(val);
			}
			if (key == "propertyMetaGenre") {
				this.setPropertyMetaGenre(val);
			}
			if (key == "propertyMetaLanguage") {
				this.setPropertyMetaLanguage(val);
			}
			if (key == "propertyMetaYear") {
				this.setPropertyMetaYear(val);
			}
			if (key == "propertyMetaCast") {
				this.setPropertyMetaCast(val);
			}
			if (key == "propertyMetaDirector") {
				this.setPropertyMetaDirector(val);
			}
			if (key == "propertyMetaOwner") {
				this.setPropertyMetaOwner(val);
			}
			if (key == "propertyMetaDuration") {
				this.setPropertyMetaDuration(val);
			}
			if (key == "propertyMetaParental") {
				this.setPropertyMetaParental(val);
			}
			if (key == "propertyMetaPrice") {
				this.setPropertyMetaPrice(val);
			}
			if (key == "propertyMetaRating") {
				this.setPropertyMetaRating(val);
			}
			if (key == "propertyMetaAudioType") {
				this.setPropertyMetaAudioType(val);
			}
			if (key == "propertyMetaAudioChannels") {
				this.setPropertyMetaAudioChannels(val);
			}

			if (key == "concurrencyProperties") {
				this.setConcurrencyProperties(val);
			}
			if (key == "concurrencyEnabled") {
				this.setConcurrencyEnabled(val);
			}
			if (key == "concurrencyCode") {
				this.setConcurrencyCode(val);
			}
			if (key == "concurrencyService") {
				this.setConcurrencyService(val);
			}
			if (key == "concurrencyMaxCount") {
				this.setConcurrencyMaxCount(val);
			}
			if (key == "concurrencyRedirectUrl") {
				this.setConcurrencyRedirectUrl(val);
			}
			if (key == "concurrencyIpMode") {
				this.setConcurrencyIpMode(val);
			}

			if (key == "resumeProperties") {
				this.setResumeProperties(val);
			}
			if (key == "resumeEnabled") {
				this.setResumeEnabled(val);
			}
			if (key == "resumeCallback") {
				this.setResumeCallback(val);
			}
			if (key == "resumeService") {
				this.setResumeService(val);
			}
			if (key == "playTimeService") {
				this.setPlayTimeService(val);
			}

			if (key == "balanceProperties") {
				this.setBalanceProperties(val);
			}
			if (key == "balanceEnabled") {
				this.setBalanceEnabled(val);
			}
			if (key == "balanceType") {
				this.setBalanceType(val);
			}
			if (key == "balanceService") {
				this.setBalanceService(val);
			}
			if (key == "balanceZoneCode") {
				this.setBalanceZoneCode(val);
			}
			if (key == "balanceOriginCode") {
				this.setBalanceOriginCode(val);
			}
			if (key == "balanceNVA") {
				this.setBalanceNVA(val);
			}
			if (key == "balanceNVB") {
				this.setBalanceNVB(val);
			}
			if (key == "balanceToken") {
				this.setBalanceToken(val);
			}
			if (key == "balanceLive") {
				this.setBalanceLive(val);
			}

			if (key == "extraparam1") {
				this.setExtraParam(1, val);
			}
			if (key == "extraparam2") {
				this.setExtraParam(2, val);
			}
			if (key == "extraparam3") {
				this.setExtraParam(3, val);
			}
			if (key == "extraparam4") {
				this.setExtraParam(4, val);
			}
			if (key == "extraparam5") {
				this.setExtraParam(5, val);
			}
			if (key == "extraparam6") {
				this.setExtraParam(6, val);
			}
			if (key == "extraparam7") {
				this.setExtraParam(7, val);
			}
			if (key == "extraparam8") {
				this.setExtraParam(8, val);
			}
			if (key == "extraparam9") {
				this.setExtraParam(9, val);
			}
			if (key == "extraparam10") {
				this.setExtraParam(10, val);
			}

			if (key == "jwplayerOverlayText") {
				this.setJwplayerOverlayText(val);
			}
			if (key == "jwplayerOverlayEnabled") {
				this.setJwplayerOverlayEnabled(val);
			}
			if (key == "jwplayerOverlayTime") {
				this.setJwplayerOverlayTime(val);
			}
			if (key == "jwplayerOverlayDuration") {
				this.setJwplayerOverlayDuration(val);
			}

			if (key == "cdnNodeData") {
				this.setCDNNodeData(val);
			}

			if (key == "nqsDebugServiceEnabled") {
				this.setNqsDebugServiceEnabled(val);
			}
			if (key == "httpSecure") {
				this.setHttpSecure(val);
			}
		...
		if (this.debug) {
			console.log("YouboraData :: collectParams :: Error :: " + error);
		}
	}
};
YouboraData.prototype.setAccountCode = function (accountCode) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setAccountCode] :: " + error);
		}
	}
};
YouboraData.prototype.getAccountCode = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getAccountCode] :: " + error);
		}
	}
};
YouboraData.prototype.setService = function (service) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setService] :: " + error);
		}
	}
};
YouboraData.prototype.getService = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getService] :: " + error);
		}
	}
};
YouboraData.prototype.setMediaResource = function (mediaResource) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setMediaResource] :: " + error);
		}
	}
};
YouboraData.prototype.getMediaResource = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getMediaResource] :: " + error);
		}
	}
};
YouboraData.prototype.setTransaction = function (transaction) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setTransaction] :: " + error);
		}
	}
};
YouboraData.prototype.getTransaction = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getTransaction] :: " + error);
		}
	}
};
YouboraData.prototype.setUsername = function (username) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setUserName] :: " + error);
		}
	}
};
YouboraData.prototype.getUsername = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getUserName] :: " + error);
		}
	}
};
YouboraData.prototype.setLive = function (bool) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setLive] :: " + error);
		}
	}
};
YouboraData.prototype.getLive = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getLive] :: " + error);
		}
	}
};
YouboraData.prototype.setResume = function (bool) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setResume] :: " + error);
		}
	}
};
YouboraData.prototype.getResume = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getResume] :: " + error);
		}
	}
};
YouboraData.prototype.setContentId = function (contentId) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setContentId] :: " + error);
		}
	}
};
YouboraData.prototype.getContentId = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getContentId] :: " + error);
		}
	}
};
YouboraData.prototype.setProperties = function (propertiesObject) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setProperties] :: " + error);
		}
	}
};
YouboraData.prototype.getProperties = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getProperties] :: " + error);
		}
	}
};
...
YouboraData.prototype.setPropertyFileName = function (filename) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyFileName] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyFileName = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyFileName] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyContentId = function (contentid) {
	try {
		this.properties.content_id = contentid;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyContentId] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyContentId = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyContentId] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyTransactionType = function (transactiontype) {
	try {
		this.properties.transaction_type = transactiontype;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyTransactionType] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyTransactionType = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyTransactionType] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyQuality = function (quality) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyQuality] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyQuality = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyQuality] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyContentType = function (contenttype) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyContentType] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyContentType = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyContentType] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyDeviceManufacturer = function (manufacturer) {
	try {
		this.properties.device.manufacturer = manufacturer;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyDeviceManufacturer] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyDeviceManufacturer = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyDeviceManufacturer] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyDeviceType = function (type) {
	try {
		this.properties.device.type = type;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyDeviceType] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyDeviceType = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyDeviceType] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyDeviceYear = function (year) {
	try {
		this.properties.device.year = year;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyDeviceYear] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyDeviceYear = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyDeviceYear] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyDeviceFirmware = function (firmware) {
	try {
		this.properties.device.firmware = firmware;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyDeviceFirmware] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyDeviceFirmware = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyDeviceFirmware] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaTitle = function (title) {
	try {
		this.properties.content_metadata.title = title;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaTitle] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaTitle = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaTitle] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaGenre = function (genre) {
	try {
		this.properties.content_metadata.genre = genre;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaGenre] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaGenre = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaGenre] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaLanguage = function (language) {
	try {
		this.properties.content_metadata.language = language;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaLanguage] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaLanguage = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaLanguage] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaYear = function (year) {
	try {
		this.properties.content_metadata.year = year;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaYear] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaYear = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaYear] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaCast = function (cast) {
	try {
		this.properties.content_metadata.cast = cast;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaCast] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaCast = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaCast] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaDirector = function (director) {
	try {
		this.properties.content_metadata.director = director;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaDirector] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaDirector = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaDirector] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaOwner = function (owner) {
	try {
		this.properties.content_metadata.owner = owner;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaOwner] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaOwner = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaOwner] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaDuration = function (duration) {
	try {
		this.properties.content_metadata.duration = duration;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaDuration] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaDuration = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaDuration] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaParental = function (parental) {
	try {
		this.properties.content_metadata.parental = parental;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaParental] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaParental = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaParental] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaPrice = function (price) {
	try {
		this.properties.content_metadata.price = price;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaPrice] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaPrice = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaPrice] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaRating = function (rating) {
	try {
		this.properties.content_metadata.rating = rating;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaRating] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaRating = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaRating] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaAudioType = function (audiotype) {
	try {
		this.properties.content_metadata.audioType = audiotype;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaAudioType] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaAudioType = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaAudioType] :: " + error);
		}
	}
};
YouboraData.prototype.setPropertyMetaAudioChannels = function (audiochannels) {
	try {
		this.properties.content_metadata.audioChannels = audiochannels;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setPropertyMetaAudioChannels] :: " + error);
		}
	}
};
YouboraData.prototype.getPropertyMetaAudioChannels = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPropertyMetaAudioChannels] :: " + error);
		}
	}
};
YouboraData.prototype.setJwplayerOverlayText = function (text) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setJwplayerOverlayText] :: " + error);
		}
	}
};
YouboraData.prototype.getJwplayerOverlayText = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getJwplayerOverlayText] :: " + error);
		}
	}
};
...
YouboraData.prototype.getJwplayerOverlayEnabled = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getJwplayerOverlayEnabled] :: " + error);
		}
	}
};
YouboraData.prototype.setJwplayerOverlayTime = function (time) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setJwplayerOverlayTime] :: " + error);
		}
	}
};
YouboraData.prototype.getJwplayerOverlayTime = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getJwplayerOverlayTime] :: " + error);
		}
	}
};
YouboraData.prototype.setJwplayerOverlayDuration = function (duration) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setJwplayerOverlayDuration] :: " + error);
		}
	}
};
YouboraData.prototype.getJwplayerOverlayDuration = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getJwplayerOverlayDuration] :: " + error);
		}
	}
};
YouboraData.prototype.setJwplayerOverlayTextColor = function (textColor) {
	try {
		this.jwplayerOverlayTextColor = textColor;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setJwplayerOverlayTextColor] :: " + error);
		}
	}
};
YouboraData.prototype.getJwplayerOverlayTextColor = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getjwplayerOverlayTextColor] :: " + error);
		}
	}
};
YouboraData.prototype.setJwplayerOverlayBackgroundColor = function (backgroudColor) {
	try {
		this.jwplayerOverlayBackgroundColor = backgroudColor;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setJwplayerOverlayBackgroundColor] :: " + error);
		}
	}
};
YouboraData.prototype.getJwplayerOverlayBackgroundColor = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getJwplayerOverlayBackgroundColor] :: " + error);
		}
	}
};
YouboraData.prototype.setJwplayerStreamMode = function (jwplayerStreamMode) {
	try {
		this.jwplayerStreamMode = jwplayerStreamMode;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setJwplayerStreamMode] :: " + error);
		}
	}
};
...
YouboraData.prototype.setConcurrencyProperties = function (concurrencyPropertiesObject) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setConcurrencyProperties] :: " + error);
		}
	}
};
YouboraData.prototype.getConcurrencyProperties = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getConcurrencyProperties] :: " + error);
		}
	}
};
YouboraData.prototype.setConcurrencyEnabled = function (enabled) {
	try {
		this.concurrencyProperties.enabled = enabled;
	} catch (err) {
		if (this.debug) {
			console.log("YouboraData :: Error [setConcurrencyEnabled] :: " + error);
		}
	}
};
YouboraData.prototype.getConcurrencyEnabled = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getConcurrencyEnabled] :: " + error);
		}
	}
};
YouboraData.prototype.setConcurrencyCode = function (code) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setConcurrencyCode] :: " + error);
		}
	}
};
YouboraData.prototype.getConcurrencyCode = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getConcurrencyCode] :: " + error);
		}
	}
};
YouboraData.prototype.setConcurrencyService = function (service) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setConcurrencyService] :: " + error);
		}
	}
};
YouboraData.prototype.getConcurrencyService = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getConcurrencyService] :: " + error);
		}
	}
};
YouboraData.prototype.getConcurrencySessionId = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getConcurrencySessionId] :: " + error);
		}
	}
};
YouboraData.prototype.setConcurrencyMaxCount = function (maxCount) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setConcurrencyMaxCount] :: " + error);
		}
	}
};
YouboraData.prototype.getConcurrencyMaxCount = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getConcurrencyMaxCount] :: " + error);
		}
	}
};
YouboraData.prototype.setConcurrencyRedirectUrl = function (redirectUrl) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setConcurrencyRedirectUrl] :: " + error);
		}
	}
};
YouboraData.prototype.getConcurrencyRedirectUrl = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getConcurrencyRedirectUrl] :: " + error);
		}
	}
};
YouboraData.prototype.setConcurrencyIpMode = function (state) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setConcurrencyIpMode] :: " + error);
		}
	}
};
YouboraData.prototype.getConcurrencyIpMode = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getConcurrencyIpMode] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceProperties = function (balancePropertiesObject) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceProperties] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceProperties = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceProperties] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceLive = function (live) {
	try {
		this.balanceProperties.live = live;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceLive] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceLive = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceLive] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceType = function (type) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceType] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceType = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceType] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceEnabled = function (state) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceEnabled] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceEnabled = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceEnabled] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceService = function (serviceURL) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceService] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceService = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceService] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceZoneCode = function (zoneCode) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceZoneCode] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceZoneCode = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceZoneCode] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceOriginCode = function (originCode) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceOriginCode] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceOriginCode = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceOriginCode] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceNVA = function (NVA) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceNVA] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceNVA = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceNVA] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceNVB = function (NVB) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceNVB] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceNVB = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceNVB] :: " + error);
		}
	}
};
YouboraData.prototype.setBalanceToken = function (token) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setBalanceToken] :: " + error);
		}
	}
};
YouboraData.prototype.getBalanceToken = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalanceToken] :: " + error);
		}
	}
};
YouboraData.prototype.setResumeProperties = function (resumePropertiesObject) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setResumeProperties] :: " + error);
		}
	}
};
YouboraData.prototype.getResumeProperties = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getResumeProperties] :: " + error);
		}
	}
};
YouboraData.prototype.setResumeEnabled = function (state) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setResumeEnabled] :: " + error);
		}
	}
};
YouboraData.prototype.getResumeEnabled = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getResumeEnabled] :: " + error);
		}
	}
};
YouboraData.prototype.setResumeCallback = function (callback) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setResumeCallback] :: " + error);
		}
	}
};
YouboraData.prototype.getResumeCallback = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getResumeCallback] :: " + error);
		}
	}
};
YouboraData.prototype.setResumeService = function (serviceURL) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setResumeService] :: " + error);
		}
	}
};
YouboraData.prototype.getResumeService = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getResumeService] :: " + error);
		}
	}
};
YouboraData.prototype.setPlayTimeService = function (serviceURL) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setPlayTimeService] :: " + error);
		}
	}
};
YouboraData.prototype.getPlayTimeService = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getPlayTimeService] :: " + error);
		}
	}
};
YouboraData.prototype.setDebug = function (status) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setDebug] :: " + error);
		}
	}
};
YouboraData.prototype.getDebug = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getDebug] :: " + error);
		}
	}
};
YouboraData.prototype.setZoneCode = function (zoneCode) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setZoneCode] :: " + error);
		}
	}
};
YouboraData.prototype.getZoneCode = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getZoneCode] :: " + error);
		}
	}
};
YouboraData.prototype.setOriginCode = function (originCode) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setOriginCode] :: " + error);
		}
	}
};
YouboraData.prototype.getOriginCode = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getOriginCode] :: " + error);
		}
	}
};
YouboraData.prototype.setCDNNodeData = function (value) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setCDNNodeData] :: " + error);
		}
	}
};
YouboraData.prototype.getCDNNodeData = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getCDNNodeData] :: " + error);
		}
	}
};
YouboraData.prototype.setParseHLS = function (value) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setParseHLS] :: " + error);
		}
	}
};
YouboraData.prototype.getParseHLS = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getParseHLS] :: " + error);
		}
	}
};
YouboraData.prototype.setCDNNodeDataObtained = function (value) {
	try {
		this.cdn_node_data_obtained = value;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setCDNNodeData] :: " + error);
		}
...
YouboraData.prototype.getCDNNodeDataObtained = function () {
	try {
		return this.cdn_node_data_obtained;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [getCDNNodeData] :: " + error);
		}
...
YouboraData.prototype.setCDN = function (value) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setCDN] :: " + error);
		}
	}
};
YouboraData.prototype.getCDN = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getCDN] :: " + error);
		}
	}
};
YouboraData.prototype.setISP = function (value) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setISP] :: " + error);
		}
	}
};
YouboraData.prototype.getISP = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getISP] :: " + error);
		}
	}
};
YouboraData.prototype.setIP = function (value) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setIP] :: " + error);
		}
	}
};
YouboraData.prototype.getIP = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getIP] :: " + error);
		}
	}
};
YouboraData.prototype.setHashTitle = function (value) {
	try {
		this.hashTitle = value;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setHashTitle] :: " + error);
		}
	}
};
YouboraData.prototype.getHashTitle = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getHashTitle] :: " + error);
		}
	}
};
YouboraData.prototype.setNiceTokenIp = function (niceTokenIp) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [niceTokenIp] :: " + error);
		}
	}
};
YouboraData.prototype.getNiceTokenIp = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getNiceTokenIp] :: " + error);
		}
	}
};
YouboraData.prototype.setExtraParam = function (position, value) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setExtraParam] :: " + error);
		}
	}
};
YouboraData.prototype.getExtraParam = function (position) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getExtraParam] :: " + error);
		}
	}
};
YouboraData.prototype.getExtraParams = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getExtraParams] :: " + error);
		}
	}
}
...
YouboraData.prototype.setEnableAnalytics = function (enabled) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [setEnableAnalytics] :: " + error);
		}
	}
};
YouboraData.prototype.getEnableAnalytics = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getEnableAnalytics] :: " + error);
		}
	}
};
YouboraData.prototype.setEnableBalancer = function (enabled) {
	try {
		this.enableBalancer = enabled;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setEnableBalancer] :: " + error);
		}
	}
};
YouboraData.prototype.getEnableBalancer = function (state) {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getEnableBalancer] :: " + error);
		}
	}
};
YouboraData.prototype.getBalancedResource = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getBalancedResource] :: " + error);
		}
	}
};
YouboraData.prototype.setBalancedResource = function (state) {
	try {
		this.isBalanced = state;
	} catch (error) {
		if (this.debug) {
			console.log("YouboraData :: Error [setBalancedResource] :: " + error);
		}
	}
};
YouboraData.prototype.setSilverlightMediaElementName = function (mediaElementName) {
	try {
		this.silverlightMediaElementName = mediaElementName;
	} catch (err) {
		if (this.debug) {
			console.log("YouboraData :: Error [setSilverlightMediaElementName] :: " + err);
		}
	}
};
YouboraData.prototype.getSilverlightMediaElementName = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getSilverlightMediaElementName] :: " + err);
		}
	}
};
...
YouboraData.prototype.getSilverlightPlayer = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [getSilverlightPlayer] :: " + err);
		}
	}
};
YouboraData.prototype.getNqsDebugServiceEnabled = function () {
	try {
		...
		if (this.debug) {
			console.log("YouboraData :: Error [GET nqsDebugServiceEnabled] :: " + error);
		}
	}
};
YouboraData.prototype.setNqsDebugServiceEnabled = function (nqsDebugEnabled) {
	try {
		this.nqsDebugServiceEnabled = nqsDebugEnabled;
	} catch (err) {
		if (this.debug) {
			console.log("YouboraData :: Error [SET nqsDebugServiceEnabled] :: " + err);
		}
	}
};
...
YouboraData.prototype.setTrackAdvertisement = function (enabled) {
	try {
		this.trackAdvertisement = enabled;
	} catch (err) {
		if (this.debug) {
			console.log("YouboraData :: Error [SET trackAdvertisement] :: " + err);
		}
	}
};
YouboraData.prototype.getTrackAdvertisement = function () {
	try {
		return this.trackAdvertisement;
	} catch (err) {
		if (this.debug) {
			console.log("YouboraData :: Error [SET trackAdvertisement] :: " + err);
		}
...
var youboraDataMap = new YouboraDataMap();
