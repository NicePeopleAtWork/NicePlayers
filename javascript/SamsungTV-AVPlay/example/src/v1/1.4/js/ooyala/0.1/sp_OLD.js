...
YouboraAnalytics = function (playerId, mb, namespace) {
    ...
    // configuration
    this.pluginVersion          = "1.3.3.2.0_ooyala";
    ...
    ***********************************************/
    ...
    error : function (errorCode) {
        try {
            ...
            this.communications.sendAdvancedError(errorCodeYoubora, this.pluginType, "", 0, window.location.href, this.getMetadata(), this.isLive, this.resource, this.videoDuration);
            clearTimeout(this.pingTimer);
            this.pingTimer = null;
        } catch(err){ console.log(err); }
    },
