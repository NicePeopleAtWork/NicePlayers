...
videojs.plugin('youbora', function(params) {
    ...
    try {
        ...
        var pluginVersion = "3.4.3-vjs-ima";
        var initDone = 0;
        var balanceObject = "";
        var balanceIndex = 1;
        var mediaEvents = {
                        ...
                        case "error":
                            try {
                                ...
                                if (_youboraData.getBalanceEnabled() && apiClass.enableBalancer) {
                                    ...
                                    isStreamError = true;
                                    apiClass.sendAdvancedError("131" + getBalancerErrorCount(), pluginName, "CDN_PLAY_FAILURE", 0, window.location.href, _options, _youboraData.getLive(), balanceObject[balanceIndex]['URL'], duration);
                                    balanceIndex++;
                                    ...
                                    apiClass.sendAdvancedError(error, pluginName, message, 0, window.location.href, _options, _youboraData.getLive(), youboraData.getMediaResource(), duration);
                                    player.youbora.reset();
                                }
                            } catch (error) {
                                if (debug) {
