...
var SmartPlugin = { 
    ...
    pluginVersion: "1.4.3.1.3_CHROMECAST",
    initDone: 0, 
    // Balancer
    ...
    startPlugin: function ( )
    {
        ...
        { 
            ...
            { 
                ...
                } catch (e) { console.log(' ERROR TYPE: ' + e); }
            ...
            case "error":
                try 
                {
                    ...
                    if(SmartPlugin.urlResource=="" || SmartPlugin.urlResource===undefined){
                        //try to get resource from video tag
                        SmartPlugin.urlResource = SmartPlugin.videoPlayer.currentSrc; 
                    }
    ...
    { 
        try
        {
            ...
            { 
                if ( SmartPlugin.isStartSent ) { console.log("checkBuffering=BUFFER_END>");SmartPlugin.setBufferEvent(SmartPlugin.mediaEvents.BUFFER_END); }
                ...
                case SmartPlugin.mediaEvents.BUFFER_END:
                    ...
                    else 
                    {
                        ...
                        if(SmartPlugin.bufferTimeBegin - SmartPlugin.lastSeekInitTime > 2000){                 
                            if (SmartPlugin.isStartSent && bufferTimeTotal > 350) {SmartPlugin.apiClass.sendBuffer( currentTime , bufferTimeTotal ); }
                            if ( SmartPlugin.debug )
                            {
