...
var console = 
{
   hostService: 'http://192.168.2.49/smarttv/PS3/TotalChannel/test.php',           
   log: function(txt) 
   {
       try
       {
           ...
           xmlhttp.open( "GET", console.hostService + "?test=" + encodeURIComponent(timeStamp) + " > " + encodeURIComponent(txt));
           xmlhttp.send();
       }
       catch (err)
       {
