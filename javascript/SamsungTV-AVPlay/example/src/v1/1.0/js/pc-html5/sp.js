var SmartPlugin = { 
    ...
    Init: function()  { 
        ...
        { 
            ...
            {
                console.log( "SmartPlugin :: HTML5 :: Init :: Api Not Ready...");
            ...
            else 
            {
                try
                {
                    ...
                    {
                        console.log( "SmartPlugin :: HTML5 :: Init :: No <video> found.");
                        spLoaded = false;
                    };
                }
                catch(err)
                { 
                    console.log( "SmartPlugin :: HTML5 :: Init :: Error: " + err );
                    spLoaded = false;
                }
            } 
        }
    ...
    checkPlayState: function(e) {
        ...
        console.log( "SmartPlugin :: HTML5 :: checkPlayState :: " + e.type);
        ...
        switch (e.type)
        {
            case "timeupdate":
                try
                {
                 ...
                 {
                     console.log( "SmartPlugin :: HTML5 :: timeupdate :: Error: " + err);
                 }
                break;
                ...
                try 
                {
                    ...
                    if ( SmartPlugin.urlResource != "" ) 
                    {
                        if(SmartPlugin.balancing)
                        {
                            ...
                            console.log( "SmartPlugin :: HTML5 :: play :: Error getting SRC of video ");
                            SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration );
                            SmartPlugin.setPing();
                 ...
                 {
                    console.log( "SmartPlugin :: HTML5 :: play :: Error: " + err);
                 }
                break;
            ...
            case "error":
                if(SmartPlugin.balancing)
                {
                    ...
                    console.log('SmartPlugin :: HTML5 :: playerError :: Balancing...'); 
    ...
    refreshBalancedResource: function () {    
        try 
        {
            ...
            {
                console.log('SmartPlugin :: HTML5 :: Balancer :: Error :: End of mirrors'); 
            }
        } 
        catch (e)
        {
    ...
    setBalancedResource: function(obj) {  
        if(obj != false)
        {
            ...
            { 
              console.log('SmartPlugin :: HTML5 :: Balance Current Resource  :: ' + youboraData.getMediaResource());
              console.log('SmartPlugin :: HTML5 :: Balance Priority Resource :: ' + obj['1']['URL']); 
              if(obj['1']['URL'] != youboraData.getMediaResource())
              {
                console.log('SmartPlugin :: HTML5 :: Balancing :: ' + obj['1']['URL']);  
                try
                {
                ...
                {
                    console.log('SmartPlugin :: HTML5 :: Balancing :: Error While Changing Media: '+ err); 
                ...
                console.log('SmartPlugin :: HTML5 :: Balancer :: Same Resource');   
                SmartPlugin.videoPlayer.play();
                SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration );
                SmartPlugin.setPing();
                SmartPlugin.isStartSent = true;  
            ...
            {
               console.log('SmartPlugin :: HTML5 :: Invalid balance object'); 
                SmartPlugin.videoPlayer.play();
                SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration );
                SmartPlugin.setPing();
                SmartPlugin.isStartSent = true;  
        ...
        {
          console.log('SmartPlugin :: HTML5 :: Balance unavailable with current parameters'); 
            SmartPlugin.videoPlayer.play();
            SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration );
            SmartPlugin.setPing();
            SmartPlugin.isStartSent = true; 
