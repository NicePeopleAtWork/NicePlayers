...
YouboraData.prototype.setJwplayerOverlayTextColor = function(textColor)
{
	...
	{ 
 		if (this.debug)
 		{
			console.log ( "YouboraData :: Error [setJwplayerOverlayTextColor] :: " + err );
		}
	}    
};
...
YouboraData.prototype.getJwplayerOverlayTextColor = function()
{
	...
	{ 
 		if (this.debug)
 		{
			console.log ( "YouboraData :: Error [getjwplayerOverlayTextColor] :: " + err );
		}
	}    
};
...
YouboraData.prototype.setJwplayerOverlayBackgroundColor = function(backgroudColor)
{
	...
	{ 
 		if (this.debug)
 		{
			console.log ( "YouboraData :: Error [setJwplayerOverlayBackgroundColor] :: " + err );
		}
	}    
};
...
YouboraData.prototype.getJwplayerOverlayBackgroundColor = function()
{
	...
	{ 
 		if (this.debug)
 		{
			console.log ( "YouboraData :: Error [getJwplayerOverlayBackgroundColor] :: " + err );
		}
	}    
};
...
YouboraData.prototype.setExtraParams = function ( extraParams )
{
	...
	{  
		...
		this.extraParams.param13 = false;
		console.log("Extra Params  in setExtraParams" );
...
YouboraData.prototype.setEnableAnalytics = function ( enabled )
{
	...
	{ 
 		if (this.debug)
 		{
			console.log ( "YouboraData :: Error [setEnableAnalytics] :: " + err );
		}
	}    
}; 

YouboraData.prototype.getEnableAnalytics = function ( enabled )
{
	return this.enableAnalytics = enabled; 
};  
...
YouboraData.prototype.setEnableBalancer = function ( enabled )
{
	...
	{ 
 		if (this.debug)
 		{
			console.log ( "YouboraData :: Error [EnableBalancer] :: " + err );
		}
	}    
}; 

YouboraData.prototype.getEnableBalancer = function ( enabled )
{
	return this.enableBalancer = enabled; 
};  

YouboraData.prototype.setOnInitCallback = function ( callback )
{
	try
	{  
