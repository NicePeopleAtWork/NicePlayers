...
{ 
    ...
    try
	{
		...
		if ( youboraData.getCDNNodeData() && this.fastDataValid ) 
		{ 
	...
	{ 
		...
		if(referer == undefined){
			try{
				...
				console.log("The referer is : " + this.referer);
			}catch(err){
				console.log ( "YouboraCommunication :: HTTP Balance Request :: Please, specify referer manually");
			}
		}else{
			this.referer = referer;
		}
		...
		{  
		    ...
		    var urlDataWithCode = service + "?type="  			+ balanceType +  
		    								...
		    								"&niceNva="			+ nva +
		    								"&niceNvb="			+ nvb +	
		    								"&token="	   		+ this.generateToken(nva,nvb); 
...
YouboraCommunication.prototype.getExtraParamsUrl= function(extraParams){
	...
	if(extraParams!=undefined){
		...
		if ( ( extraParams.param1 != undefined ) && ( extraParams.param1 != "" ) )
			    	 params += "&param1=" + extraParams.param1;	    
		if ( ( extraParams.param2 != undefined ) && ( extraParams.param2 != "" ) )
			params += "&param2=" + extraParams.param2;
	    if ( ( extraParams.param3 != undefined ) && ( extraParams.param3 != "" ) )
			params += "&param3=" + extraParams.param3;
	    if ( ( extraParams.param4 != undefined ) && ( extraParams.param4 != "" ) )
			params += "&param4=" + extraParams.param4;
	    if ( ( extraParams.param5 != undefined ) && ( extraParams.param5 != "" ) )
			params += "&param5=" + extraParams.param5;
		if ( ( extraParams.param6 != undefined ) && ( extraParams.param6 != "" ) )
			params += "&param6=" + extraParams.param6;
	    if ( ( extraParams.param7 != undefined ) && ( extraParams.param7 != "" ) )
		   	params += "&param7=" + extraParams.param7;
	    if ( ( extraParams.param8 != undefined ) && ( extraParams.param8 != "" ) )
			params += "&param8=" + extraParams.param8;
	    if ( ( extraParams.param9 != undefined ) && ( extraParams.param9 != "" ) )
			params += "&param9=" + extraParams.param9;
	    if ( ( extraParams.param10 != undefined ) && ( extraParams.param10 != "" ) )
			params += "&param10=" + extraParams.param10;
		if ( ( extraParams.param11 != undefined ) && ( extraParams.param11 != "" ) )
			params += "&param11=" + extraParams.param11;
	    if ( ( extraParams.param12 != undefined ) && ( extraParams.param12 != "" ) )
	  		params += "&param12=" + extraParams.param12;
	    if ( ( extraParams.param13 != undefined ) && ( extraParams.param13 != "" ) )
...
YouboraCommunication.prototype.calculateNVA = function(niceNVA)
{
	...
	console.log(" NVA NOTVALIDAFTER: "+notValidAfter);
...
YouboraCommunication.prototype.calculateBaseTime = function(){
	...
	currentTime = currentTime  + (offset * 60 * 1000); //-60, UTC+1 is -1h difference, it returns -60 minutos
	
	console.log(" offset:"+offset);
	
	console.log(" currentTime + offset:"+currentTime);
	//currentTime = currentTime + (120 * 60000);
	//console.log(" currentTime + 2hours:"+currentTime);
	return currentTime;*/
	...
	console.log(" currentTime (d.getTime) :"+currentTime);

	var currentTimeCorrected = (currentTime + (offset *60 *1000) );
	
	currentTimeCorrected = currentTime;

	console.log(" offset1 :"+currentTimeCorrected);

	console.log(" difference in time :"+ (currentTimeCorrected-currentTime));
