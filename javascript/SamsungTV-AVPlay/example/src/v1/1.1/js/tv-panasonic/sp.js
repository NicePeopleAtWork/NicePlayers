var SmartPlugin = { 
    ...
    initDone: false,
    Init: function()  { 
        console.log( "SmartPlugin :: PANASONICTV :: Init ::");
        try
        { 
            if ( spYoubora.isYouboraApiLoaded () == false ) 
            {
                console.log( "SmartPlugin :: PANASONICTV :: Init :: Api Not Ready...");
            ...
            else 
            {
                try
                {
                    if ( typeof document.getElementsByTagName("video")[0] != "undefined")
                    {
                        ...
                        SmartPlugin.communicationClass = new YouboraCommunication(youboraData.getAccountCode(), youboraData.getService(), SmartPlugin.bandwidth, '2.0.0', 'PANASONIC_HTML5');  
                        SmartPlugin.bindEvents();
                        spLoaded = true;
                    }
                    else
                    {
                        console.log( "SmartPlugin :: PANASONICTV :: Init :: No <video> found.");
                        spLoaded = false;
                    };
                }
                catch(err)
                { 
                    console.log( "SmartPlugin :: PANASONICTV :: Init :: Error: " + err );
                    spLoaded = false;
                }
            } 
        }
    ...
    checkPlayState: function(e) {
        ...
        console.log( "SmartPlugin :: PANASONICTV :: checkPlayState :: " + e.type);
        ...
        switch (e.type)
        {
            case "timeupdate":
                try
                {
                 ...
                 {
                     console.log( "SmartPlugin :: PANASONICTV :: timeupdate :: Error: " + err);
                 }
                break;
                ...
                { 
                    ...
                    if ( SmartPlugin.urlResource != "" ) 
                    {
                        if(SmartPlugin.balancing)
                        {
                            ...
                            console.log( "SmartPlugin :: PANASONICTV :: play :: Error getting SRC of video ");
                            SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration );
                            SmartPlugin.setPing();
                 ...
                 {
                    console.log( "SmartPlugin :: PANASONICTV :: play :: Error: " + err);
                 }
                break;
            ...
            case "error":
                if(SmartPlugin.balancing)
                {
                    ...
                    console.log('SmartPlugin :: PANASONICTV :: playerError :: Balancing...'); 
    ...
    refreshBalancedResource: function () {    
        try 
        {
            ...
            {
                console.log('SmartPlugin :: PANASONICTV :: Balancer :: Error :: End of mirrors'); 
            }
        } 
        catch (e)
        {
    ...
    setBalancedResource: function(obj) {  
        if(obj != false)
        {
            ...
            { 
              console.log('SmartPlugin :: PANASONICTV :: Balance Current Resource  :: ' + youboraData.getMediaResource());
              console.log('SmartPlugin :: PANASONICTV :: Balance Priority Resource :: ' + obj['1']['URL']); 
              if(obj['1']['URL'] != youboraData.getMediaResource())
              {
                console.log('SmartPlugin :: PANASONICTV :: Balancing :: ' + obj['1']['URL']);  
                try
                {
                ...
                {
                    console.log('SmartPlugin :: PANASONICTV :: Balancing :: Error While Changing Media: '+ err); 
                ...
                console.log('SmartPlugin :: PANASONICTV :: Balancer :: Same Resource');   
                SmartPlugin.videoPlayer.play();
                SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration );
                SmartPlugin.setPing();
                SmartPlugin.isStartSent = true;  
            ...
            {
                console.log('SmartPlugin :: PANASONICTV :: Invalid balance object'); 
                SmartPlugin.videoPlayer.play();
                SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration );
                SmartPlugin.setPing();
                SmartPlugin.isStartSent = true;  
        ...
        {
          console.log('SmartPlugin :: PANASONICTV :: Balance unavailable with current parameters'); 
            SmartPlugin.videoPlayer.play();
            SmartPlugin.communicationClass.sendStart( 0 , window.location.href , SmartPlugin.getMetadata() , youboraData.getLive() , SmartPlugin.urlResource , SmartPlugin.duration );
            SmartPlugin.setPing();
            SmartPlugin.isStartSent = true; 
    ...
    setBufferEvent: function(bufferState)
    {
        ...
        { 
            console.log ( "SmartPlugin :: PANASONICTV :: Error " + e );
        }
    },
    setPing: function()
    {  
