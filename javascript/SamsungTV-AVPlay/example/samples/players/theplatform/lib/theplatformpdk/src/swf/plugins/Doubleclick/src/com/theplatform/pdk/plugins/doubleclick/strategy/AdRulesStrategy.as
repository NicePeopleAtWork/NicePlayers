...
import com.google.ads.ima.api.AdsManager;
	...
	public class AdRulesStrategy implements IDoubleClickStrategy
	{
        ...
        private var _adBreakStarted:Boolean = false;
        ...
        /**
         * This gets called when the OnContentResumeRequested event fires. Unfortunately, this
         * event fires at startup for ad rules before any preroll even plays. Because of this,
         * we have to return a value here to know that case versus the normal case (actually resume
         * content when an ad break finishes).
         * @return Boolean True if we were playing an ad break; False if this is just the adsManager startup sequence.
         */
        public function contentResumeRequested():Boolean
        {
            ...
            var returnVal:Boolean = _adBreakStarted;
            _adBreakStarted = false;
            return returnVal;
        }
