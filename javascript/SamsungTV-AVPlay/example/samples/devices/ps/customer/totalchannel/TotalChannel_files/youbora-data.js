...
YouboraData.prototype.init = function () {
    try { 
        ...
        this.collectParams();
        return true; 
    } catch (error) { if (this.debug) { console.log("YouboraData :: Init Error: " + error); }  }
};
...
YouboraData.prototype.setProperties = function (propertiesObject) {
    try { 
        if (typeof propertiesObject == "string") { propertiesObject = JSON.parse(propertiesObject); } 
        if (typeof propertiesObject == "object") { this.properties = propertiesObject; } 
